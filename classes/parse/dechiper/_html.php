<?php 
namespace parse\dechiper;

/**
 * Website: http://sourceforge.net/projects/simple_html_dom/
...
// example use;
// function __read_html($str,$lowercase=true,$stripRN=true,$forceTagsClosed=true)
// {
// 	foreach ([
...
class _html {
	...
	static function DOM(
		...
		if(!self::$dom_class){
			self::$dom_class = new _html($str,$lowercase,$forceTagsClosed,$target_charset,$stripRN,$defaultBRText,$defaultSpanText,$options); 
		}

		return self::$dom_class;
	}
